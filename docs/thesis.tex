...
\begin{document}
	...
	\section{Components}
		The goal of Internet Protocol Security is to provide security at the network layer, being used worldwide to either deploy a VPN (site-to-site or host-to-site) or to implement end-to-end security. It is also often used by other protocols (e.g. L2TP, MIPv6, GRE) to protect some or all of their traffic.
